...
public class TripDetail extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void settingInformation() {
        if (getIntent() != null)
        {
//            registerDestAddress(getIntent().getStringExtra("end_address"));
    ...
    private void registerDestAddress(String address) {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        final DatabaseReference end_position = db.getReference(Common.register_current_order).child(Common.passengerID).child("end_position");
//        Map<String, String> end_address = new HashMap<String, String>();
//        end_address.put("end_position", address);
//        current_order.push().setValue(end_address);
        end_position.setValue(address);
